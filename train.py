...
from src.probabilistic_unet.model import ProbabilisticUnet
from src.probabilistic_unet.loss import *
from src.probabilistic_unet.unet import Unet
...
def build_parser():
    ...
    parser.add_argument('--train_data_dir', type=str, default='/Users/phulocnguyen/Documents/Workspace/GeneralizedProbabilisticUNet/dataset')
    parser.add_argument('--model', type=str, default='punet')
    parser.add_argument('--checkpoint_dir', type=str, default='/Users/phulocnguyen/Documents/Workspace/GeneralizedProbabilisticUNet/ckpt')
...
if __name__ == '__main__':
    ...
    local_dir = os.path.join(args.checkpoint_dir)
